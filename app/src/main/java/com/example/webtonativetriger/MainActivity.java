...
public class MainActivity extends AppCompatActivity {
    ...
    private final String BASE_URL = "file:///android_asset/webview.html";
    @Override
...
//        Webview debugging Enable
        ...
        /*addJavascriptInterface is add interface to webview
        * Webclient is need */
...
//Listeners
    ...
    /*Javascript interface class need to add javascript method in webview
    *@JavascriptInterface
        public void textFromWeb(String value){
            textFromWeb.setText(value);
        }
        * that overide method callback from webview
        *  */
